DROP PROCEDURE IF EXISTS usersettings.GetOffersWithDelayOfPayment;

CREATE DEFINER = 'RootDBMS'@'127.0.0.1'
PROCEDURE usersettings.GetOffersWithDelayOfPayment(IN ClientCodeParam INT UNSIGNED, IN FreshOnly BOOLEAN)
BEGIN
