...
OR NEW.ManualComparison != OLD.ManualComparison
OR NEW.ParseWaybills != OLD.ParseWaybills
OR NEW.SendRetailMarkup != OLD.SendRetailMarkup
OR NEW.ShowAdvertising != OLD.ShowAdvertising
OR NEW.IgnoreNewPrices != OLD.IgnoreNewPrices
OR NEW.SendWaybillsFromClient != OLD.SendWaybillsFromClient
OR NEW.OnlyParseWaybills != OLD.OnlyParseWaybills
OR NEW.UpdateToTestBuild != OLD.UpdateToTestBuild
OR NEW.EnableSmartOrder != OLD.EnableSmartOrder
)
then
