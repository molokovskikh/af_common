...
if (select FirmCodeOnly from retclientsset join future.Users on Users.ClientId = retclientsset.ClientCode where clientcode = UserIdParam) is not null then
...
INSERT INTO MinCosts(MinCost, ProductId, RegionCode)
SELECT  
        min(Cost),
        ProductId,
        RegionCode
